...
export class SoniatComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  ngOnInit() {
    ...
    this.saveMessage("Hola me llamo Clark y seré tu proveedor líder durante la consulta, por favor coméntame ¿En qué puedo ayudarte?",false)
  }
  ngAfterViewInit(){
    this.scrollToBottom();
